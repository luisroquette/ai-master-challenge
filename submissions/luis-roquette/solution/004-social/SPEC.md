...
- Gate vigente após I40: **102/102 testes** com warnings como erro. O contrato ativo é `METHOD_VERSION = "2.0.0"`; eventos `1.0.0` continuam legíveis, mas são incompatíveis para nova comparação automática (`pending / method_mismatch`). Artefatos canônicos: `evidence.csv` SHA-256 `017588dfa23f032684066c049f2f5aac4a380e5615de029b80e57a29311b3f1e`; `analysis.md` SHA-256 `c65b42f631c3532433683b2cf2cbdcea1be74147cfc86cc38146b13f52859fe6`; HTML reproduzido SHA-256 `a90d85f64b20e0d2c556cba2bcfda09378e16f07c4507f25927ad0a5f29f7fb1`.
