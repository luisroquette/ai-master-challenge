...
- Gate vigente após a correção da Passada 4: **116/116 testes** com warnings como erro. O contrato ativo é `METHOD_VERSION = "2.2.0"`; eventos `1.0.0`, `2.0.0` e `2.1.0` continuam legíveis, mas são incompatíveis para nova comparação automática (`pending / method_mismatch`). Artefatos canônicos: `evidence.csv` SHA-256 `9fb2d4dbc769863cdb4e8d92b1a8267d0799f9e21a3f6c38bc48b3e141446a98`; `analysis.md` SHA-256 `4038018d466e195c0960f9dba24d4dddbc61bb89dda499b7edee657b7e6860f0`; HTML reproduzido SHA-256 `99a493cbc7cde5d355283f173a8db15e564cdbf718c85c48fd7cb1159afb915c`.
