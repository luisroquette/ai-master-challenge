...
| CK-08 | pass | decisão/revisão preservam texto, snapshot alvo/comparador, IDs por papel, idempotência e reinício; `test_storage.py`, `test_app.py`, I38–I44 |
| CK-09 | pass | contrato observado reaplica segmento/estatística; relógio real bloqueia futuro, replay é SIMULAÇÃO, método antigo é incompatível e negativo fraco pede coleta; I40–I44 |
| CK-10 | pass | HTML normal/adversarial em uma A4; CSV reconstruído na ordem `export_field` → `analysis_field` → `history_field`; cinco provas focais fiéis; I39–I44 |
| CK-11 | pass | app local/teclado, sem conta, API ou ação automática; I26–I44 |
...
| HR-03 | pass | I01–I44 preservam pesquisa, 24 ondas, decisões, falhas, correções e limites |
| HR-04 | pass | setup, cinco provas focais, remoção do diário 001 e auditoria Git restrita à submissão; I37 e I44 |
