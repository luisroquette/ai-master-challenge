...
- Gate vigente após a correção da Passada 7: **122/122 testes** com warnings como erro. O contrato ativo é `METHOD_VERSION = "2.4.0"`; eventos `1.0.0`–`2.3.0` continuam legíveis, mas são incompatíveis para nova comparação automática (`pending / method_mismatch`). O CSV publica seis recomendações em 6.703 registros; o top 3 permanece a síntese executiva. Artefatos canônicos: `evidence.csv` SHA-256 `9c01467b7242bf0bd1af3180d1f56fae0c3e527719b4b8e5d716ab0ce674e66d`; `analysis.md` SHA-256 `41ab16f88839869bb7693778e4e1f72d54d1815c66ef30ceb5c31e19bc109084`; HTML reproduzido SHA-256 `6e0c84ab59cae9318384113f7cd490eb9e48153c1f06ec4b427bc5248ec3f90d`.
