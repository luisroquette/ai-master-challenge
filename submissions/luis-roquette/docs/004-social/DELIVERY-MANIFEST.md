...
1. Começar pelo [README da submissão](../../README.md) e ler as três respostas em 30 segundos.
2. Abrir o tour Arcade de sete etapas: `https://app.arcade.software/share/VHx5b51f94IAFSr6pmds`.
3. Aprofundar pelo [estudo de caso](./CONSTRUCTION-STORY.md), [vídeo](./assets/notebooklm-video.mp4), [mapa mental](./assets/notebooklm-mind-map.png), [infográfico](./assets/notebooklm-infographic.png) e [diário](../../process-log/004-social.md).
