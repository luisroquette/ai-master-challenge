...
| CK-06 | pass | prioridade recomposta com mediana temporal real, ordem estável e fila completa além do top 3; `test_analysis.py`, `test_app.py`, I45 |
| CK-07 | pass | esforço, público, frequência mensal por semanas completas, patrocínio, creators, interrupção e quick wins; I34–I35 |
| CK-08 | pass | decisão/revisão preservam texto, snapshot alvo/comparador, IDs por papel, idempotência, reinício e ação adicional; `test_storage.py`, `test_app.py`, I38–I45 |
| CK-09 | pass | contrato observado reaplica segmento/estatística; relógio real bloqueia futuro, replay é SIMULAÇÃO, método antigo é incompatível e negativo fraco pede coleta; I40–I45 |
| CK-10 | pass | HTML normal/adversarial em uma A4; período solicitado/efetivo/parcial exportado; CSV reconstruído na ordem `export_field` → `analysis_field` → `history_field`; cinco provas focais fiéis; I39–I45 |
| CK-11 | pass | app local/teclado, fila completa, sem conta, API ou ação automática; I26–I45 |
...
| HR-03 | pass | I01–I45 preservam pesquisa, 24 ondas, decisões, falhas, correções e limites |
| HR-04 | pass | setup, cinco provas focais, remoção do diário 001 e auditoria Git restrita à submissão; I37 e I45 |
