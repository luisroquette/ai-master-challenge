...
- Gate vigente após I43: **109/109 testes** com warnings como erro. O contrato ativo é `METHOD_VERSION = "2.1.0"`; eventos `1.0.0` e `2.0.0` continuam legíveis, mas são incompatíveis para nova comparação automática (`pending / method_mismatch`). Artefatos canônicos: `evidence.csv` SHA-256 `3a91736cd23c52b2c1603f2ebb0d0324195a41997b6f15c331ad1f042626394b`; `analysis.md` SHA-256 `8fd5a1e524b798294553cfc4eb5e538001c258623b54cd6adf42281e224deba7`; HTML reproduzido SHA-256 `a5cf43b65d561d13f65709da7334d1ca69c26b3536f2b7a4d704f3b479691f9b`.
