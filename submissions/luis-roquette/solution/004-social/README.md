...
Após a correção dos dois achados da Passada 5, o gate acumulado aprovou **119/119 testes** com warnings tratados como erros. A CLI real foi repetida byte a byte: `evidence.csv` SHA-256 `7e94c3352f596bb912ccad74346b4aa3796e7290a748d36ac06300653f80e2fc`, `analysis.md` `10e043722772a349676194febcbed1a8a4b9bed2864e0c60da1352ea47831fe0` e HTML `8098fa88096e252782636a548b29b5a9b2e748f3ad3179fa5f3833efa36cacef`. O CSV contém seis recomendações e 6.703 registros; o resumo normal e a fixture adversarial permaneceram em uma página A4.

As três prioridades executivas mantiveram scores e ordem sob IDs 2.3.0: `sponsorship-424e514026f65b4e`, `sponsorship-356e6a6a33bbaf2b` e `sponsorship-8043e720f477a417`. O CSV preserva ainda `sponsorship-5feb0d6da02b1272`, `sponsorship-4d7b76584368632e` e `sponsorship-dcb0a8ef32c2d428`, na mesma fila decidível da UI.
...
O histórico mostra o snapshot mesmo sem CSV. Reenviar o mesmo hash verifica referências pelo escopo salvo, inclusive quando a recomendação não está na fila ativa ou os filtros mudaram. `METHOD_VERSION = "2.3.0"` é o contrato ativo. Eventos `1.0.0`, `2.0.0`, `2.1.0` e `2.2.0` continuam legíveis, mas são incompatíveis para nova comparação automática e ficam `pending / method_mismatch`. As capturas históricas/outcomes preservadas na submissão registram eventos criados sob 2.0.0; não são apresentadas como nova comparação 2.3.0.
