...
- Gate vigente após a correção da Passada 5: **119/119 testes** com warnings como erro. O contrato ativo é `METHOD_VERSION = "2.3.0"`; eventos `1.0.0`, `2.0.0`, `2.1.0` e `2.2.0` continuam legíveis, mas são incompatíveis para nova comparação automática (`pending / method_mismatch`). O CSV publica a fila integral de seis recomendações em 6.703 registros; o top 3 permanece a síntese executiva. Artefatos canônicos: `evidence.csv` SHA-256 `7e94c3352f596bb912ccad74346b4aa3796e7290a748d36ac06300653f80e2fc`; `analysis.md` SHA-256 `10e043722772a349676194febcbed1a8a4b9bed2864e0c60da1352ea47831fe0`; HTML reproduzido SHA-256 `8098fa88096e252782636a548b29b5a9b2e748f3ad3179fa5f3833efa36cacef`.
